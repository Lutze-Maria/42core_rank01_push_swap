...
/*   Updated: 2026/07/22 10:47:45 by lschawer         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	sa(t_stack_node **a, bool checker, t_container container)
{
	swap(a);
	container.rrr++;
	if (!checker)
...
void	sb(t_stack_node **b, bool checker, t_container container)
{
	swap(b);
	container.rrr++;
	if (!checker)
